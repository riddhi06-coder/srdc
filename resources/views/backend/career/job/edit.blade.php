                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-job.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="title" type="text" name="title" placeholder="Enter Title" value="{{ old('title', $details->title) }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="experience" type="text" name="experience" placeholder="Enter Experience" value="{{ old('experience', $details->experience) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="status" type="text" name="status" placeholder="Enter Status" value="{{ old('status', $details->status) }}" required>
