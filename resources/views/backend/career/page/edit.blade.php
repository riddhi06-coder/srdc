            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Page Details</li>
                </ol>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-career.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="bannerImagePreviewContainer" style="margin-top: 10px; {{ $details->banner_image ? '' : 'display: none;' }}">
                                                @if($details->banner_image)
                                                    <img id="banner_image_preview" src="{{ asset('/uploads/careers/' . $details->banner_image) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                @else
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if(!empty($entry['image']))
                                                                <img src="{{ asset('uploads/careers/' . $entry['image']) }}" class="img-preview mt-2" style="max-width: 100px;">
