            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="{{ route('manage-privacy.index') }}">Home</a>
                    </li>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-privacy.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            <label class="form-label" for="policy_details">Policy Details <span class="txt-danger">*</span></label>
                                            <textarea id="summernote" class="form-control" name="policy_details" rows="6" placeholder="Enter Policy Details here" required >{{ old('policy_details', $details->policy_details) }}</textarea>
                                            <div class="invalid-feedback">Please enter Policy Details here.</div>
                                        </div>


                                        <!-- Form Actions -->
                                        <div class="col-12 text-end">
                                            <a href="{{ route('manage-privacy.index') }}" class="btn btn-danger px-4">Cancel</a>
