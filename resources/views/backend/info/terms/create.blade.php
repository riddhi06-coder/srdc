                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-terms.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote" class="form-control" name="terms" rows="6" placeholder="Enter Policy Details here" required >{{ old('terms') }}</textarea>
