              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('srdc-about.create') }}" class="btn btn-primary px-5 radius-30">+ Add About Details</a>
							    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->banner_image)
                                            <img src="{{ asset('uploads/about/' . $item->banner_image) }}" alt="Banner Image" style="max-width: 300px;">
                                        @else
