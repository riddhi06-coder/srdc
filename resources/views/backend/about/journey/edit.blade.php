                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('srdc-about.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <!-- Preview Section (Updated for edit) -->
                                            <div id="ImagePreviewContainer" style="margin-top: 10px; {{ $details->about_image ? '' : 'display: none;' }}">
                                                @if($details->about_image)
                                                    <img id="image_preview" src="{{ asset('/uploads/about/' . $details->about_image) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                @else
                                                    <img id="image_preview" src="" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px; display: none;">
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="experience" type="text" name="experience" placeholder="Enter Years of Experience" value="{{ old('experience', $details->experience) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="exp_title" type="text" name="exp_title" placeholder="Enter Experience Title" value="{{ old('exp_title', $details->exp_title) }}" required>
                                        ...
                                        <div class="table-container mb-4 md-5" style="margin-bottom: 20px;">
                                            <table class="table table-bordered p-3" id="printsTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                @php
                                                    $oldEntries = old('banner_items', $banner_items ?? [['year' => '', 'title' => '', 'description' => '']]);
                                                @endphp
