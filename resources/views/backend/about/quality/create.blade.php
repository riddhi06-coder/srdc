                                ...
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-quality.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="short_description" class="form-control" name="short_description" rows="5" placeholder="Enter Short Description here" required >{{ old('short_description') }}</textarea>
