                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-rnd.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="innovation_heading" type="text" name="innovation_heading" placeholder="Enter Innovation Heading" value="{{ old('innovation_heading', $details->innovation_heading) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!-- Preview Section (Moved here) -->
                                            <div id="innovation_2ImagePreviewContainer" style="margin-top: 10px; {{ $details->innovation_image_2 ? '' : 'display: none;' }}">
                                                <img id="innovation_2_image_preview" src="{{ $details->innovation_image_2 ? asset('/uploads/about/' . $details->innovation_image_2) : '' }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote2" class="form-control" name="innovation_description" rows="5" placeholder="Enter Innovation Description here" required >{{ old('innovation_description', $details->innovation_description) }}</textarea>
