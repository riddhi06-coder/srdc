        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Manufacturing Facility Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('about-manu.index') }}">Home</a>
                    </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>Manufacturing Facility Details Form</h4>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('about-manu.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <hr>
                                        <h5 class="mb-4"><strong># Section 1</strong></h5>

                                        
                                        <!-- Banner Heading-->
                                        <div class="col-md-6">
                                            <label class="form-label" for="section1_heading">Section Heading <span class="txt-danger">*</span></label>
                                            <input class="form-control" id="section1_heading" type="text" name="section1_heading" placeholder="Enter Section Heading" value="{{ old('section1_heading', $details->section1_heading) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!-- Preview Section (Moved here) -->
                                            <div id="infraImagePreviewContainer" style="margin-top: 10px; {{ $details->infra_image ? '' : 'display: none;' }}">
                                                <img id="infra_image_preview" src="{{ $details->infra_image ? asset('/uploads/about/' . $details->infra_image) : '' }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        </div>
                                        ...
                                        <hr>
                                        <h5 class="mb-4"><strong># Section 2</strong></h5>


                                        <!-- Banner Heading-->
                                        <div class="col-md-6">
                                            <label class="form-label" for="infra_heading">Section 2 Heading <span class="txt-danger">*</span></label>
                                            <input class="form-control" id="infra_heading" type="text" name="infra_heading" placeholder="Enter Infra Heading" value="{{ old('infra_heading', $details->infra_heading) }}" required>
                                            <div class="invalid-feedback">Please enter a Infra Heading.</div>
                                        </div>

                                         <!-- Image Upload -->
                                         <div class="col-md-6">
                                            <label class="form-label" for="innovation_image_3">Image<span class="txt-danger">*</span></label>
                                            ...
                                            <!-- Preview Section (Moved here) -->
                                            <div id="innovation_3ImagePreviewContainer" style="margin-top: 10px; {{ $details->innovation_image_3 ? '' : 'display: none;' }}">
                                                <img id="innovation_3_image_preview" src="{{ $details->innovation_image_3 ? asset('/uploads/about/' . $details->innovation_image_3) : '' }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote1" class="form-control" name="infra_description" rows="5" placeholder="Enter Infra Description here" required >{{ old('infra_description', $details->infra_description) }}</textarea>
                                            <div class="invalid-feedback">Please enter Infra Description here.</div>
                                        </div>


                                        <hr>
                                        <h5 class="mb-4"><strong># Section 3</strong></h5>

                                        <!-- Image Upload -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="innovation_image_1">Image<span class="txt-danger">*</span></label>
                                            ...
                                            <!-- Preview Section (Moved here) -->
                                            <div id="innovation_1ImagePreviewContainer" style="margin-top: 10px; {{ $details->innovation_image_1 ? '' : 'display: none;' }}">
                                                <img id="innovation_1_image_preview" src="{{ $details->innovation_image_1 ? asset('/uploads/about/' . $details->innovation_image_1) : '' }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        </div>
                                        ...
                                        <!-- Description -->
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            <label class="form-label" for="innovation_description">Description <span class="txt-danger">*</span></label>
                                            <textarea id="summernote2" class="form-control" name="innovation_description" rows="5" placeholder="Enter Description here" required >{{ old('innovation_description', $details->innovation_description) }}</textarea>
                                            <div class="invalid-feedback">Please enter Description here.</div>
                                        </div>
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('about-manu.index') }}" class="btn btn-danger px-4">Cancel</a>
