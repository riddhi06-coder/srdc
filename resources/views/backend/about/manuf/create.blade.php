        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Manufacturing Facility Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('about-manu.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section1_heading" type="text" name="section1_heading" placeholder="Enter Section Heading" value="{{ old('section1_heading') }}" required>
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote2" class="form-control" name="innovation_description" rows="5" placeholder="Enter Description here" required >{{ old('innovation_description') }}</textarea>
                                            <div class="invalid-feedback">Please enter Description here.</div>
                                        </div>
