                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('aim-vision.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="ImagePreviewContainer" style="margin-top: 10px; {{ $details->image ? '' : 'display: none;' }}">
                                                <img 
                                                    id="image_preview" 
                                                    src="{{ $details->image ? asset('uploads/about/' . $details->image) : '' }}" 
                                                    alt="Preview" 
                                                    class="img-fluid" 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="Vision_title" type="text" name="Vision_title" placeholder="Enter Vision Title" value="{{ old('Vision_title', $details->vision_title) }}" required>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input class="form-control" id="vision_image" type="file" name="vision_image" accept=".jpg, .jpeg, .png, .webp" onchange="previewVisionImage()">
                                            <div class="invalid-feedback">Please upload an image.</div>
                                            <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                            <br>
                                            <small class="text-secondary"><b>Only .jpg, .jpeg, .png, .webp formats are allowed.</b></small>
                                            ...
                                            <div id="VisionImagePreviewContainer" style="margin-top: 10px; {{ $details->vision_image ? '' : 'display: none;' }}">
                                                <img 
                                                    ...
                                                    src="{{ $details->vision_image ? asset('uploads/about/' . $details->vision_image) : '' }}" 
                                                    alt="Preview" 
                                                    class="img-fluid" 
                                                    style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote1" class="form-control" name="vision_description" rows="5" placeholder="Enter Vision Description here" required >{{ old('vision_description', $details->vision_description) }}</textarea>
