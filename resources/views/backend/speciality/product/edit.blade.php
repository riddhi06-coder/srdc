                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('manage-products.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="product_name" type="text" name="product_name"
                                            ...
                                            value="{{ old('product_name', $details->product_name) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @php
                                            $selectedIndustries = old('industry_id', json_decode($details->industry_ids, true) ?? []);
                                        @endphp
                                        <select id="industry_id" name="industry_id[]" multiple class="form-control" required>
                                            @foreach ($industries as $item)
                                                <option value="{{ $item->id }}" {{ in_array($item->id, $selectedIndustries) ? 'selected' : '' }}>
                                                    {{ $item->industry_name }}
                                                </option>
                                            @endforeach
                                        </select>
