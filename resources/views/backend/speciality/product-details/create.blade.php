                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('managing-products-details.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                      ...
                                      <!-- Product Name -->
                                            ...
                                            <select class="form-control" id="product_name" name="product_name" required>
                                                ...
                                                @foreach($products as $product)
                                                    <option value="{{ $product->id }}" {{ old('product_name') == $product->id ? 'selected' : '' }}>
                                                        {{ $product->product_name }} <!-- Assuming 'name' is the column for product names -->
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="cas_no" type="text" name="cas_no" placeholder="Enter CAS No" value="{{ old('cas_no') }}" required>
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="mol_wt" type="text" name="mol_wt" placeholder="Enter MOL. Wt" value="{{ old('mol_wt') }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_title_1" type="text" name="section_title_1" placeholder="Enter Section Title" value="{{ old('section_title_1') }}" required>
                                            <div class="invalid-feedback">Please enter a Section Title.</div>
                                        </div>
                                        ...
                                        <div class="table-container" style="margin-bottom: 20px;">
                                            <table class="table table-bordered p-3" id="printsTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        $oldHeadings = old('application_name', ['']);
                                                    @endphp
                                       ...
                                       <!-- Document Upload -->
                                        <div class="col-md-6">
                                            ...
                                            <div id="documentPreview" style="margin-top: 10px; display: none;">
                                                ...
                                                <img id="imagePreview" src="" alt="Image Preview" style="display: none; max-width: 100%; max-height: 200px; margin-top: 10px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        </div>
