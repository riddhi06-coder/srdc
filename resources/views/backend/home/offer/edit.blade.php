                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('we-offer.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-xxl-4 col-sm-6 mb-4">
                                            ...
                                            <input class="form-control" id="title" type="text" name="title" placeholder="Enter Banner Title" value="{{ old('title', $details->title) }}" required>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if(!empty($entry['image']))
                                                                <img src="{{ asset('uploads/home/' . $entry['image']) }}" class="img-preview mt-2" style="max-width: 100px;">
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('we-offer.index') }}" class="btn btn-danger px-4">Cancel</a>
