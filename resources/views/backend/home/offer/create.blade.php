                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('we-offer.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-xxl-4 col-sm-6 mb-4">
                                            ...
                                            <input class="form-control" id="title" type="text" name="title" placeholder="Enter Banner Title" value="{{ old('title') }}" required>
