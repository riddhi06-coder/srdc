                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('description.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote" class="form-control" name="section_description" rows="5" placeholder="Enter Section Description here" required >{{ old('section_description') }}</textarea>
                                        ...
                                        <div class="table-container mb-4" style="margin-bottom: 20px;">
                                            ...
                                            <table class="table table-bordered p-3" id="advantageTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                <tbody>
                                                    @php
                                                        $oldAdvantages = old('advantage_items', $details->advantages ?? [['id' => '', 'name' => '', 'description' => '']]);
                                                    @endphp
