                                    ...
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('banner-home.update', $banner_details->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            @if($banner_details->video)
                                                <div class="mt-2 existing-video-preview">
                                                    <video controls width="100%" autoplay muted loop controls style="border: 1px solid #ccc; border-radius: 5px;">
                                                        <source src="{{ asset('/uploads/banner/' . $banner_details->video) }}" type="video/mp4">
                                        ...
                                        <div class="table-container" style="margin-bottom: 20px;">
                                            ...
                                            <table class="table table-bordered p-3" id="printsTable" style="border: 2px solid #dee2e6;">
                                                ...
                                                @php
                                                    $oldHeadings = old('banner_heading', json_decode($banner_details->banner_headings, true));
                                                @endphp
                                                <tbody>
       ...
       <!--Banner Heading Preview & Add More Option-->
        ...
        <script>
            document.getElementById('banner_video').addEventListener('change', function () {
                ...
                const existingVideo = document.querySelector('.existing-video-preview');
