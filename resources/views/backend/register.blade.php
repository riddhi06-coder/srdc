    ...
    <div class="container-fluid p-0"> 
        <div class="row m-0">
            ...
            <div class="login-card login-dark">
                <div>
                <div><a class="logo" href="{{ route('admin.login') }}"> <img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/logo.webp') }}" alt="" style="max-width: 40% !important;"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/logo.webp') }}" alt="looginpage" style="max-width: 40% !important;"></a></div>
