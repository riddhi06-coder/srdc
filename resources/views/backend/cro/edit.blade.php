                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-cro.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="bannerImagePreviewContainer" style="margin-top: 10px; {{ $details->banner_image ? '' : 'display: none;' }}">
                                                @if($details->banner_image)
                                                    <img id="banner_image_preview" src="{{ asset('/uploads/cro/' . $details->banner_image) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                @else
                                        ...
                                        <h4># Section 1</h4>
                                         ...
                                         <div class="col-md-6 mb-4">
                                            ...
                                            <!-- Preview Section -->
                                            <div id="ImagePreviewContainer" style="margin-top: 10px; {{ $details->image ? '' : 'display: none;' }}">
                                                <img 
                                                    id="image_preview" 
                                                    src="{{ $details->image ? asset('uploads/cro/' . $details->image) : '' }}" 
                                                    alt="Preview" 
                                                    class="img-fluid" 
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div id="VisionImagePreviewContainer" style="margin-top: 10px; {{ $details->vision_image ? '' : 'display: none;' }}">
                                                <img 
                                                    ...
                                                    src="{{ $details->vision_image ? asset('uploads/cro/' . $details->vision_image) : '' }}" 
                                                    alt="Preview" 
                                                    class="img-fluid" 
                                                    style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote1" class="form-control" name="section_description" rows="6" placeholder="Enter Section Description here" required >{{ old('section_description', $details->section_description) }}</textarea>
                                          ...
                                          <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="section_description1" class="form-control" name="section_description1" rows="6" placeholder="Enter Section Description 2 here" required >{{ old('section_description1', $details->section_description1) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="section_title1" type="text" name="section_title1" placeholder="Enter Section Title" value="{{ old('section_title1', $details->section_title1) }}" required>
                                            <div class="invalid-feedback">Please enter a Section Title.</div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <!-- Preview Section -->
                                            <div id="Image3PreviewContainer" style="margin-top: 10px; {{ $details->image3 ? '' : 'display: none;' }}">
                                                <img 
                                                    id="image3_preview" 
                                                    src="{{ $details->image3 ? asset('uploads/cro/' . $details->image3) : '' }}" 
                                                    alt="Preview" 
                                                    class="img-fluid" 
                                                    style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                         ...
                                         <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="summernote2" class="form-control" name="section_description2" rows="6" placeholder="Enter Section Description here" required >{{ old('section_description2', $details->section_description2) }}</textarea>
                                            <div class="invalid-feedback">Please enter Section Description here.</div>
                                        </div>
                                          ...
                                          <div class="col-md-12" style="margin-bottom: 20px;">
                                            ...
                                            <textarea id="section_description3" class="form-control" name="section_description3" rows="6" placeholder="Enter Section Description 2 here" required >{{ old('section_description3', $details->section_description3) }}</textarea>
                                            <div class="invalid-feedback">Please enter Section Description 2 here.</div>
                                        </div>
