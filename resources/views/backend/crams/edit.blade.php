        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit CRAMS Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('home-crams.index') }}">About</a>
                    </li>
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                    <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-crams.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="bannerImagePreviewContainer" style="margin-top: 10px; {{ $details->banner_image ? '' : 'display: none;' }}">
                                                @if($details->banner_image)
                                                    <img id="banner_image_preview" src="{{ asset('/uploads/crams/' . $details->banner_image) }}" alt="Preview" class="img-fluid" style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                                @else
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px;">
                                         ...
                                         <div class="col-md-6 mb-4">
                                            <label class="form-label" for="image">Image 1<span class="txt-danger">*</span></label>
                                            ...
                                            <div id="ImagePreviewContainer" style="margin-top: 10px; {{ $details->image ? '' : 'display: none;' }}">
                                                <img 
                                                    id="image_preview" 
                                                    src="{{ $details->image ? asset('uploads/crams/' . $details->image) : '' }}" 
                                                    alt="Preview" 
                                                    class="img-fluid" 
                                        ...
                                        <!-- Image 2Upload -->
                                        <div class="col-md-6 mb-4">
                                            <label class="form-label" for="vision_image">Image 2<span class="txt-danger">*</span></label>
                                        ...
                                        <!-- Image 3 Upload -->
                                        <div class="col-md-6 mb-4">
                                            <label class="form-label" for="image3">Image 3<span class="txt-danger">*</span></label>
                                            ...
                                            <div id="Image3PreviewContainer" style="margin-top: 10px; {{ $details->image3 ? '' : 'display: none;' }}">
                                                <img 
                                                    id="image3_preview" 
                                                    src="{{ $details->image3 ? asset('uploads/crams/' . $details->image3) : '' }}" 
                                                    alt="Preview" 
                                                    class="img-fluid" 
                                                    style="max-height: 200px; border: 1px solid #ddd; padding: 5px;">
                                            </div>
                                        ...
                                        <div class="col-12 text-end">
                                            <a href="{{ route('home-crams.index') }}" class="btn btn-danger px-4">Cancel</a>
